<script lang="ts" context="module">
    ...
    function adjustedLinesAndMatch(lines: readonly string[], range: NonNullable<ReferencePanelCodeExcerpt_Location['range']>): [readonly string[], Match] {
        ...
        const match: Match = {
            ...
            endCharacter: range.end.character - (lines[lines.length - 1].length - trimmedLines[trimmedLines.length - 1].length),
        }
